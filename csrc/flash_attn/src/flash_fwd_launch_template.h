...
template<typename T, int Headdim, bool Use_fp8_kv_cache>
void run_mha_fwd_splitkv_dispatch(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    run_flash_splitkv_fwd<Flash_fwd_kernel_traits<Headdim, kBlockM, kBlockN, 4, false, false, T, Use_fp8_kv_cache>>(params, stream);
}
